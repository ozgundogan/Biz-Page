 ...
 *  @package    Zebra_Image
 */
Class ImageOperations extends Teknolobi {
    ...
    public function apply_filter($filter, $arg1 = '', $arg2 = '', $arg3 = '', $arg4 = '') {
        ...
        if (function_exists('imagefilter'))
            ...
            if ($this->_create_from_source()) {
                ...
                // write image
                $this->editedimage = $target_identifier;
     ...
     *
     *                                          -   <b>self::ZEBRA_IMAGE_BOXED</b> - the image will be scaled so that it will
     ...
     *
     *                                          -   <b>self::ZEBRA_IMAGE_NOT_BOXED</b> - the image will be scaled so that it
    ...
    public function rotate($angle, $background_color = -1) {
        ...
        if ($use_existing_source || $this->_create_from_source()) {
            ...
            } else $this->editedimage = $target_identifier; //return $this->_write_image($target_identifier);
    ...
    public function save() {
        return $this->_write_image($this->editedimage);
    }
